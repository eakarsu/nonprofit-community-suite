...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Nonprofit Community Dashboard"
      subtitle="One merged nonprofit community view for Programs, Clients, Volunteers, Donors, Grants, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared nonprofit community jobs into one surface. Programs, Clients, Volunteers, Donors, Grants, Campaigns, documents, audit, and AI are presented as platform features.</div>
