...
const featureSeeds = [
  ['programs', 'Programs', 'Programs operating queue', 'Programs Lead', 'Review and assign next action'],
  ['clients', 'Clients', 'Clients operating queue', 'Programs Lead', 'Review and assign next action'],
  ['volunteers', 'Volunteers', 'Volunteers operating queue', 'Programs Lead', 'Review and assign next action'],
  ['donors', 'Donors', 'Donors operating queue', 'Programs Lead', 'Review and assign next action'],
  ['grants', 'Grants', 'Grants operating queue', 'Operations Lead', 'Review and assign next action'],
  ['campaigns', 'Campaigns', 'Campaigns operating queue', 'Operations Lead', 'Review and assign next action'],
  ['food-pantry', 'Food Pantry', 'Food Pantry operating queue', 'Operations Lead', 'Review and assign next action'],
  ['field-operations', 'Field Operations', 'Field Operations operating queue', 'Operations Lead', 'Review and assign next action'],
  ['events', 'Events', 'Events operating queue', 'Governance Lead', 'Review and assign next action'],
  ['impact', 'Impact', 'Impact operating queue', 'Governance Lead', 'Review and assign next action'],
  ['cases', 'Cases', 'Cases operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
