...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Programs Packet', type: 'Programs', owner: 'Programs Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Clients Review Bundle', type: 'Clients', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Volunteers Evidence Set', type: 'Volunteers', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
