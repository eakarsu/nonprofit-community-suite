...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Programs alert', detail: 'Programs queue needs review.', read: false },
  { id: 'note-2', title: 'Clients approval due', detail: 'Clients exception list needs approval.', read: false },
  { id: 'note-3', title: 'Volunteers updated', detail: 'Volunteers operating queue was refreshed.', read: true },
];
