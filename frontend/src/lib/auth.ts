export const AUTH_COOKIE = 'nonprofit_community_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@nonprofit-community.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@nonprofit-community.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@nonprofit-community.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
