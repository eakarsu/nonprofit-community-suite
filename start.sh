...
PORT="${PORT:-4110}"
DB_NAME="${PGDATABASE:-nonprofit_community_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Nonprofit Community Suite"
echo "======================================="
echo
...
echo "Starting nonprofit community suite frontend on http://localhost:$PORT"
echo "Login: admin@nonprofit-community.local / admin123"
